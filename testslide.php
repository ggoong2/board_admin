                ...
                <div class="table-responsive">
                    <table class="table table-bordered" width="50%" cellspacing="0">
                        ...
                        <tbody>
                            <?php
                                ...
                                while($board = $sql->fetch_array()){
                                    if($board["file"] == null){
                                        ...
                                        echo "<th id=slide_text>$src3</th></tr>";
                            ...
                            ?>
                            <!-- // <button type='button' name='slide_img' id='add' data-toggle='modal'data-target='#add_data_Modal' class='btn btn-warning'>
                            // <img id = 'slide_img' src=slide_img/$src>
                            // </th></button>";  -->
                        </tbody>
                    </table>
            ...
            <div>
                <div id='my_modal'>
                    ...
                    <a href="#" class="btn btn-primary btn-icon-split btn-lg">
                        ...
                        <span id="popup_open_btn">1번 이미지 수정하기</span>
                    </a>
            </div>
            <div>
                <div id='my_modal2'>
                    ...
                    <div  class="modal-body">
                        <form action="slide_modify_ok2.php?view=2" method="post" enctype="multipart/form-data">
                            <div>
                               <input type="file" name="b_file"/>
                            </div>
                ...
                <a href="#" class="btn btn-primary btn-icon-split btn-lg">
                        ...
                        <span id="popup_open_btn2">2번 이미지 수정하기</span>
                </a>
            </div>
            <div>
                <div id='my_modal3'>
                    ...
                    <div  class="modal-body">
                        <form action="slide_modify_ok2.php?view=3" method="post" enctype="multipart/form-data">
                            <div>
                               <input type="file" name="b_file"/>
                            </div>
                ...
                <a href="#" class="btn btn-primary btn-icon-split btn-lg">
                        ...
                        <span id="popup_open_btn3">3번 이미지 수정하기</span>
                </a>
            </div>
        </div>
    </div>
